...
1. Откройте **[shebzukho.com/admin](https://shebzukho.com/admin)**
...
> В админке нельзя сломать формат — каждое поле это отдельная форма
> с вкладками для 4 языков (RU / EN / ADY / TR).
